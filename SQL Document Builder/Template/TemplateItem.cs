...
namespace SQL_Document_Builder.Template
{
    ...
    internal class TemplateItem
    {
                    ...
                    switch (elementName)
                    {
                        case "documenttype":
                            if (elementValue.Length > 0)
                                this.DocumentType = elementValue;
                            break;
                        ...
                        case "body":
                            this.TemplateBody = elementValue;
                            break;
        ...
        internal void Write(XmlWriter writer)
        {
            ...
            writer.WriteElementString("documentType", this.DocumentType);
            writer.WriteElementString("name", this.Name);
            writer.WriteElementString("body", this.TemplateBody);
