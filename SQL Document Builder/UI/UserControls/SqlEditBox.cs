...
namespace SQL_Document_Builder.UI.UserControls
{
    ...
    /// The sql edit box.
    /// </summary>
    internal class SqlEditBox : Scintilla
    {
        ...
        public Font DefaultStyleFont
        {
            ...
            set
            {
                ...
                {
                    Styles[i].Font = value.Name;
                    Styles[i].SizeF = value.Size;
                }
        ...
        public bool DarkMode
        {
            set
            {
                if (_darkMode != value)
                {
                    ...
                    if (_darkMode)
                    {
                        BackColor = IntToColor(0x212121);
                        ForeColor = IntToColor(0xFFFFFF);
                    }
                    else
                    {
        ...
        private void InitColors()
        {
            ...
            SelectionBackColor = IntToColor(0x114D9C);
        }
        ...
        private void InitSyntaxColoringDefault()
        {
            ...
            StyleResetDefault();
            Styles[Style.Default].Font = "Cascadia Mono";
        ...
        private void InitSyntaxColoringHtml()
        {
            ...
            if (_darkMode)
            {
                ...
                // HTML styles
                Styles[Style.Html.Default].ForeColor = Color.White;
                Styles[Style.Html.Tag].ForeColor = Color.DeepSkyBlue;           // <tag>
                Styles[Style.Html.TagEnd].ForeColor = Color.DeepSkyBlue;        // </tag>
                Styles[Style.Html.TagUnknown].ForeColor = Color.Red;
                Styles[Style.Html.Attribute].ForeColor = Color.Orange;          // attribute=
                Styles[Style.Html.AttributeUnknown].ForeColor = Color.Red;
                Styles[Style.Html.Number].ForeColor = Color.LightGreen;
                Styles[Style.Html.DoubleString].ForeColor = Color.LightYellow;  // "string"
                Styles[Style.Html.SingleString].ForeColor = Color.LightYellow;  // 'string'
                Styles[Style.Html.Other].ForeColor = Color.LightGray;
                Styles[Style.Html.Comment].ForeColor = Color.MediumSeaGreen;    // <!-- comment -->
                Styles[Style.Html.Entity].ForeColor = Color.Violet;             // &entity;
                Styles[Style.Html.Value].ForeColor = Color.LightYellow;

                // Script/CSS blocks inside HTML
                Styles[Style.Html.Script].ForeColor = Color.LightPink;
                Styles[Style.Html.Asp].ForeColor = Color.LightSkyBlue;
                Styles[Style.Html.CData].ForeColor = Color.LightSlateGray;
            ...
            else
            {
                ...
                Styles[Style.Html.Default].ForeColor = Color.Black;
                Styles[Style.Html.Tag].ForeColor = Color.Blue;                  // <tag>
                Styles[Style.Html.TagEnd].ForeColor = Color.Blue;               // </tag>
                Styles[Style.Html.TagUnknown].ForeColor = Color.Red;
                Styles[Style.Html.Attribute].ForeColor = Color.Brown;           // attribute=
                Styles[Style.Html.AttributeUnknown].ForeColor = Color.Red;
                Styles[Style.Html.Number].ForeColor = Color.DarkCyan;
                Styles[Style.Html.DoubleString].ForeColor = Color.DarkGreen;    // "string"
                Styles[Style.Html.SingleString].ForeColor = Color.DarkGreen;    // 'string'
                Styles[Style.Html.Other].ForeColor = Color.Gray;
                Styles[Style.Html.Comment].ForeColor = Color.Green;             // <!-- comment -->
                Styles[Style.Html.Entity].ForeColor = Color.Purple;             // &entity;
                Styles[Style.Html.Value].ForeColor = Color.DarkGoldenrod;

                // Script/CSS blocks inside HTML
                Styles[Style.Html.Script].ForeColor = Color.MediumVioletRed;
                Styles[Style.Html.Asp].ForeColor = Color.MediumBlue;
                Styles[Style.Html.CData].ForeColor = Color.Gray;
        ...
        private void InitSyntaxColoringJson()
        {
            ...
            if (_darkMode)
            {
                ...
                // JSON styles
                Styles[Style.Json.Default].ForeColor = Color.White;
                Styles[Style.Json.Number].ForeColor = Color.LightGreen;
                Styles[Style.Json.String].ForeColor = Color.LightYellow;
                Styles[Style.Json.PropertyName].ForeColor = Color.DeepSkyBlue;
                Styles[Style.Json.EscapeSequence].ForeColor = Color.Violet;
                Styles[Style.Json.Keyword].ForeColor = Color.DodgerBlue; // true, false, null
                Styles[Style.Json.LdKeyword].ForeColor = Color.Orange;   // JSON-LD keywords
                Styles[Style.Json.Operator].ForeColor = Color.LightGray; // : , { } [ ]
                Styles[Style.Json.BlockComment].ForeColor = Color.MediumSeaGreen;
                Styles[Style.Json.LineComment].ForeColor = Color.MediumSeaGreen;
            ...
            else
            {
                ...
                Styles[Style.Json.Default].ForeColor = Color.Black;
                Styles[Style.Json.Number].ForeColor = Color.DarkCyan;
                Styles[Style.Json.String].ForeColor = Color.Brown;
                Styles[Style.Json.PropertyName].ForeColor = Color.RoyalBlue;
                Styles[Style.Json.EscapeSequence].ForeColor = Color.Purple;
                Styles[Style.Json.Keyword].ForeColor = Color.Blue; // true, false, null
                Styles[Style.Json.LdKeyword].ForeColor = Color.DarkOrange;   // JSON-LD keywords
                Styles[Style.Json.Operator].ForeColor = Color.Gray; // : , { } [ ]
                Styles[Style.Json.BlockComment].ForeColor = Color.ForestGreen;
                Styles[Style.Json.LineComment].ForeColor = Color.ForestGreen;
        ...
        private void InitSyntaxColoringMarkdown()
        {
            ...
            if (_darkMode)
            {
                ...
                // Markdown styles
                Styles[Style.Markdown.Default].ForeColor = Color.White;
                Styles[Style.Markdown.LineBegin].ForeColor = Color.Gray;
                Styles[Style.Markdown.Strong1].ForeColor = Color.Orange;      // Bold **
                Styles[Style.Markdown.Strong2].ForeColor = Color.Orange;      // Bold __
                Styles[Style.Markdown.Em1].ForeColor = Color.Gold;            // Italic *
                Styles[Style.Markdown.Em2].ForeColor = Color.Gold;            // Italic _
                Styles[Style.Markdown.Header1].ForeColor = Color.DeepSkyBlue;
                Styles[Style.Markdown.Header2].ForeColor = Color.DodgerBlue;
                Styles[Style.Markdown.Header3].ForeColor = Color.LightSkyBlue;
                Styles[Style.Markdown.Header4].ForeColor = Color.LightBlue;
                Styles[Style.Markdown.Header5].ForeColor = Color.LightSteelBlue;
                Styles[Style.Markdown.Header6].ForeColor = Color.SkyBlue;
                Styles[Style.Markdown.PreChar].ForeColor = Color.LightGreen;  // Code block marker (`)
                Styles[Style.Markdown.UListItem].ForeColor = Color.LightSalmon;
                Styles[Style.Markdown.OListItem].ForeColor = Color.LightSalmon;
                Styles[Style.Markdown.BlockQuote].ForeColor = Color.MediumSeaGreen;
                Styles[Style.Markdown.Strikeout].ForeColor = Color.LightGray;
                Styles[Style.Markdown.HRule].ForeColor = Color.DarkGray;
                Styles[Style.Markdown.Link].ForeColor = Color.Violet;
                Styles[Style.Markdown.Code].ForeColor = Color.LightGreen;
                Styles[Style.Markdown.Code2].ForeColor = Color.LightGreen;
                Styles[Style.Markdown.CodeBk].BackColor = Color.FromArgb(40, 60, 40);
            ...
            else
            {
                ...
                Styles[Style.Markdown.Default].ForeColor = Color.Black;
                Styles[Style.Markdown.LineBegin].ForeColor = Color.DarkGray;
                Styles[Style.Markdown.Strong1].ForeColor = Color.DarkOrange;      // Bold **
                Styles[Style.Markdown.Strong2].ForeColor = Color.DarkOrange;      // Bold __
                Styles[Style.Markdown.Em1].ForeColor = Color.Goldenrod;           // Italic *
                Styles[Style.Markdown.Em2].ForeColor = Color.Goldenrod;           // Italic _
                Styles[Style.Markdown.Header1].ForeColor = Color.RoyalBlue;
                Styles[Style.Markdown.Header2].ForeColor = Color.MediumBlue;
                Styles[Style.Markdown.Header3].ForeColor = Color.SteelBlue;
                Styles[Style.Markdown.Header4].ForeColor = Color.CadetBlue;
                Styles[Style.Markdown.Header5].ForeColor = Color.SlateGray;
                Styles[Style.Markdown.Header6].ForeColor = Color.Gray;
                Styles[Style.Markdown.PreChar].ForeColor = Color.ForestGreen;     // Code block marker (`)
                Styles[Style.Markdown.UListItem].ForeColor = Color.OrangeRed;
                Styles[Style.Markdown.OListItem].ForeColor = Color.OrangeRed;
                Styles[Style.Markdown.BlockQuote].ForeColor = Color.SeaGreen;
                Styles[Style.Markdown.Strikeout].ForeColor = Color.Gray;
                Styles[Style.Markdown.HRule].ForeColor = Color.DarkGray;
                Styles[Style.Markdown.Link].ForeColor = Color.Purple;
                Styles[Style.Markdown.Code].ForeColor = Color.ForestGreen;
                Styles[Style.Markdown.Code2].ForeColor = Color.ForestGreen;
                Styles[Style.Markdown.CodeBk].BackColor = Color.FromArgb(230, 230, 210);
        ...
        private void InitSyntaxColoringSQL()
        {
            ...
            // Configure the default style
            StyleResetDefault();
            Styles[Style.Default].Font = "Cascadia Mono";   // "Consolas";
            Styles[Style.Default].Size = 10;
            ...
            if (_darkMode)
            {
                ...
                Styles[Style.Sql.Comment].ForeColor = Color.RosyBrown; // IntToColor(0xBD758B);
                Styles[Style.Sql.CommentLine].ForeColor = Color.MediumSeaGreen; // IntToColor(0x40BF57);
                Styles[Style.Sql.CommentDoc].ForeColor = Color.SeaGreen; // IntToColor(0x2FAE35);
                Styles[Style.Sql.Number].ForeColor = Color.Yellow; // IntToColor(0xFFFF00);
                Styles[Style.Sql.String].ForeColor = Color.Yellow; // IntToColor(0xFFFF00);
                Styles[Style.Sql.Character].ForeColor = Color.IndianRed; // IntToColor(0xE95454);
                Styles[Style.Sql.Operator].ForeColor = Color.LightGray; // IntToColor(0xE0E0E0);
                Styles[Style.Sql.Identifier].ForeColor = Color.LightSteelBlue; // IntToColor(0xD0DAE2);
                Styles[Style.Sql.CommentLineDoc].ForeColor = Color.CornflowerBlue; // IntToColor(0x77A7DB);
                Styles[Style.Sql.Word].ForeColor = Color.DodgerBlue; // IntToColor(0x48A8EE);
                Styles[Style.Sql.Word2].ForeColor = Color.DarkOrange; // IntToColor(0xF98906);
                Styles[Style.Sql.CommentDocKeyword].ForeColor = Color.DarkSeaGreen; // IntToColor(0xB3D991);
                Styles[Style.Sql.CommentDocKeywordError].ForeColor = Color.Red; // IntToColor(0xFF0000);
                Styles[Style.Sql.SqlPlus].ForeColor = Color.LightGray; // IntToColor(0xD3D3D3);
                Styles[Style.Sql.SqlPlusPrompt].ForeColor = Color.LightGreen;  // IntToColor(0x90EE90);
                Styles[Style.Sql.SqlPlusComment].ForeColor = Color.DarkGray;   // IntToColor(0xA9A9A9);
                Styles[Style.Sql.User1].ForeColor = Color.LightBlue;   // IntToColor(0xADD8E6);
                Styles[Style.Sql.User2].ForeColor = Color.LightPink;   // IntToColor(0xFFB6C1);
                Styles[Style.Sql.User3].ForeColor = Color.Orange;  // IntToColor(0xFFA500);
                Styles[Style.Sql.User4].ForeColor = Color.Cyan;    // IntToColor(0x00FFFF);
                Styles[Style.Sql.QuotedIdentifier].ForeColor = Color.LightYellow;  // IntToColor(0xFFFF00);
                Styles[Style.Sql.QOperator].ForeColor = Color.Magenta; // IntToColor(0xFF00FF);
            ...
            else
            {
                ...
                Styles[Style.Sql.CommentDoc].ForeColor = Color.ForestGreen;
                Styles[Style.Sql.Number].ForeColor = Color.DarkCyan;
                Styles[Style.Sql.String].ForeColor = Color.Brown;
                Styles[Style.Sql.Character].ForeColor = Color.DarkRed;
                Styles[Style.Sql.Operator].ForeColor = Color.DarkBlue;
                Styles[Style.Sql.Identifier].ForeColor = Color.Black;
                Styles[Style.Sql.CommentLineDoc].ForeColor = Color.Teal;
                Styles[Style.Sql.Word].ForeColor = Color.Blue;
                Styles[Style.Sql.Word2].ForeColor = Color.DarkMagenta;
                Styles[Style.Sql.CommentDocKeyword].ForeColor = Color.OliveDrab;
                Styles[Style.Sql.CommentDocKeywordError].ForeColor = Color.Red;
                Styles[Style.Sql.SqlPlus].ForeColor = Color.Gray;
                Styles[Style.Sql.SqlPlusPrompt].ForeColor = Color.DarkGreen;
                Styles[Style.Sql.SqlPlusComment].ForeColor = Color.Gray;
                Styles[Style.Sql.User1].ForeColor = Color.MediumBlue;
                Styles[Style.Sql.User2].ForeColor = Color.MediumVioletRed;
                Styles[Style.Sql.User3].ForeColor = Color.DarkOrange;
                Styles[Style.Sql.User4].ForeColor = Color.DarkCyan;
                Styles[Style.Sql.QuotedIdentifier].ForeColor = Color.DarkGoldenrod;
                Styles[Style.Sql.QOperator].ForeColor = Color.Purple;
            ...
            SetKeywords(0, SQL_KeyWords + SQL_KeyWords1); // Add the primary keywords
            SetKeywords(1, SQL_KeyWords2); // Add the data types as secondary keywords

            // User1 = 4
            SetKeywords(4, "all and any between cross exists in inner is join left like not null or outer pivot right some unpivot ( ) * ");
            // User2 = 5
            SetKeywords(5, "sys objects sysobjects ");
        }
        ...
        {
            int maxLineNumber = Lines.Count.ToString().Length;
            //int numberWidth = TextRenderer.MeasureText(maxLineNumber.ToString(), this.Font).Width;
            Margins[NUMBER_MARGIN].Width = TextWidth(Style.LineNumber, new string('9', maxLineNumber + 1)) + 5;
        }
        ...
        private void InitCodeFolding()
        {
            ...
            var foldingMargin = Margins[FOLDING_MARGIN];
            ...
            if (_darkMode)
            {
                for (int i = 25; i <= 31; i++)
                {
                    Markers[i].SetForeColor(IntToColor(BACK_COLOR)); // Foreground for [+] and [-]
                    Markers[i].SetBackColor(IntToColor(FORE_COLOR)); // Background for [+] and [-]
                }
            }
            else
            {
                for (int i = 25; i <= 31; i++)
                {
                    Markers[i].SetForeColor(Color.White); // Foreground for [+] and [-]
                    Markers[i].SetBackColor(Color.Gray);  // Background for [+] and [-]
                }
            }
        ...
        private void InitNumberMargin()
        {
            ...
            else
            {
                ...
                Styles[Style.IndentGuide].ForeColor = Color.LightGray;
                Styles[Style.IndentGuide].BackColor = Color.White;
            }
            ...
            MarginClick += Scintilla1_MarginClick;
        }
        ...
        internal void OpenFile(string fileName)
        {
            ...
            if (File.Exists(fileName))
            {
                ...
                EmptyUndoBuffer(); // Clear undo history so undo can't go back to blank
                SetSavePoint();    // Mark the current state as clean
        ...
        private FileOperationTypeEnums GetLogType()
        {
            ...
            if (!string.Equals(fileContent, Text, StringComparison.Ordinal))
